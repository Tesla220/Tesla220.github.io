/*=============================================================================*/
/* Длина молнии и мощность
/*=============================================================================*/
function p() {
document.sparklength.power.value=parseInt((document.sparklength.length.value/4.32)*(document.sparklength.length.value/4.32));
}
function l() {
document.sparklength.length.value=parseInt(4.32*Math.sqrt(document.sparklength.power.value));
}
...
/*=============================================================================*/
  this.createL= function(x, y, canSpawn){
    this.lightning.push({
      x: x=273,
      y: y=450,
      xRange: this.rand(document.sparklength.length.value/40, document.sparklength.length.value/40),
      yRange: this.rand(document.sparklength.length.value/40, document.sparklength.length.value/40),
      path: [{
        x: x,
        y: y
      }],
      pathLimit: this.rand(20, 80),
      canSpawn: canSpawn,
      hasFired: false
    });
  };
...
/*=============================================================================*/
  this.updateL = function(){
    ...
    var k = parseInt(Math.random()*(10-1)+1);
    while(i--){
      var light = this.lightning[i];


      light.path.push({
        x: light.path[light.path.length-1].x + (this.rand(0, light.xRange)+(light.xRange)/k),
        y: light.path[light.path.length-1].y + (5-k)*(this.rand(0, light.yRange))
      });
